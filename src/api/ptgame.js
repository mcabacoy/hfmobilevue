iapiConf = {"casinoname":"greenjade88","loginServer":"login.greenjade88.com","clientSkin":"greenjade88","clientType":"casino","clientPlatform":"flash","clientVersion":null,"systemId":"974","serviceType":"GamePlay","loginDomainRetryCount":"2","loginDomainRequestTimeout":"30","loginDomainRetryInterval":"1","fingerprintEnabled":"0","onlypostrequestsforlogout":null,"useIframeForGetLoggedInPlayer":"0"};
...
function iapiMakeRedirectRequest(url, postParams, requestType, loginServers)
{
  ...
  if (requestType == iapiCALLOUT_LOGIN || requestType == iapiCALLOUT_LOGINANDGETTEMPTOKEN)
  {
    if (iapiConf['fingerprintEnabled'] == '1')
    {
      ...
      iapiConf['fingerprint'] = FingerprintObject.getFingerprint(shortFb);
    }
  }
  else
  {
...
function iapiAppendContextParameters(url)
{
  ...
  var contextFields = [
    ...
    'deviceType', 'osName', 'osVersion', 'deviceBrowser', 'languageCode', 'deviceFamily', 'fingerprint'];
